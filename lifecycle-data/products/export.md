...
ms.locfileid: "940900"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="48a15-103">Gyvavimo ciklo duomenų eksportavimas</span><span class="sxs-lookup"><span data-stu-id="48a15-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="48a15-104">Šis puslapis yra tobulinamas.</span><span class="sxs-lookup"><span data-stu-id="48a15-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="48a15-105">Visų produktų eksportavimas</span><span class="sxs-lookup"><span data-stu-id="48a15-105">Export all products</span></span>
<span data-ttu-id="48a15-106">Visų produktų eksportavimo trukmės duomenis, spustelėję toliau:</span><span class="sxs-lookup"><span data-stu-id="48a15-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="48a15-107">Visų produktų eksportavimas</span><span class="sxs-lookup"><span data-stu-id="48a15-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="48a15-108">Produktų eksportavimas pagal šeimą ir grupę</span><span class="sxs-lookup"><span data-stu-id="48a15-108">Export products by Family and Group</span></span>
<span data-ttu-id="48a15-109">Pasirinkite šeimą, tada – grupę, kurią eksportuosite.</span><span class="sxs-lookup"><span data-stu-id="48a15-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="48a15-110">Pastaba: eksportavimas prasidės pasirinkus grupės reikšmę.</span><span class="sxs-lookup"><span data-stu-id="48a15-110">Note: Export will begin when Group value is selected.</span></span> 
...
> - [("Microsoft 365" | Įmonės mobilumas + sauga)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20365'%20and%20parent/parent/name%20eq%20'Enterprise%20Mobility%20%2B%20Security')
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="48a15-171">Produktų eksportavimas pagal palaikymo datą</span><span class="sxs-lookup"><span data-stu-id="48a15-171">Export products by end of support date</span></span>
<span data-ttu-id="48a15-172">Pasirinkite metus, kad pamatytumėte produktus, kurie pasiekia palaikymo pabaigą.</span><span class="sxs-lookup"><span data-stu-id="48a15-172">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="48a15-173">Pastaba: eksportavimas prasidės, kai bus pažymėta metų reikšmė.</span><span class="sxs-lookup"><span data-stu-id="48a15-173">Note: Export will begin when Year value is selected.</span></span>
